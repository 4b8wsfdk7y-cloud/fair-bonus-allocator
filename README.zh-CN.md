...
**想象你是公司老板。** 你有 8 个部门，¥1,000,000 奖金池要分给他们。销售卖得多，采购降本多，制造效率提升多，每个人都说自己贡献大。你怎么分才**公平**——让每个人都看得见逻辑，没人觉得被坑？

难在哪：每个部门的"业绩"单位不一样。销售看营收（元），制造看效率（%），质量看客诉（件数）。你不能直接比"销售 200"和"制造 95"——这两个数字根本不在一个世界里。

**这个工具用 5 步解决。你不用懂数学，只要懂这 5 步。**

### 第 1 步：把所有 KPI 翻译成"利润元"

销售多卖了 ¥30M 营收，按 8% 利润率 = ¥2.4M 利润。
采购降本 ¥2M，直接就是 ¥2.4M 利润。
制造效率提升 5%，值 ¥1.25M 利润。

**现在大家单位一样了：都是利润元。** 销售 ¥2.4M、采购 ¥2M、制造 ¥1.25M——突然就能比了。谁给公司挣的利润多，谁拿的奖金就多。不是谁的数字大谁就拿得多。

### 第 2 步：让"干得好"在每个部门含义相同

不然"A 档"在销售那里可能比在采购那里难得多——这不公平。我们调档位线，让**任何部门到 A 档，都闭合公司利润缺口的相同份额**。销售到 A 档 = 采购到 A 档 = 制造到 A 档，价值相同。

### 第 3 步：奖金池切两半

- **一半按人头分（基础池）：** 20 人的部门拿 10 人部门的两倍。这是"你来上班了"那部分。同人数同基础。
- **一半按贡献分（绩效池）：** 贡献利润多的部门拿得多。同贡献同绩效。

为什么切两半？纯按人头对绩优者不公平，纯按绩效对小而关键的团队不公平。切两半让你调平衡——多数公司用 30% 基础 / 70% 绩效。

### 第 4 步：不确定的钱不发

如果你估的"销售 +¥30M = ¥2.4M 利润"这个估计不靠谱（专家拍脑袋、样本小），你**不能按 ¥2.4M 全额发**。只发你有 95% 把握挣到的那部分。如果估计太飘，整个贡献按零算——**不确定的钱不发**。

这是整个系统"能辩护"的关键。有人问"为什么销售这次拿少了？"，你指着置信区间说"因为这次 β 估计的不确定性大，我们不敢确认贡献是真的"。

### 第 5 步：6 道安全检查必须全过才发钱

工具说"可以发薪了"之前，自动跑 6 个检查：
- 实际分出去的钱是不是在 90%~100% 之间？（不能只分了 50%，也不能分 110%）
- 每个奖金都是非负的吧？（不能有负工资）
- 达成 KPI 的人，贡献分也是非负的吧？
- 配额加起来等于 100% 吧？
- "同贡献同奖金"这条真的成立吧？
...
**任何一道挂掉，工具直接打印 `DO NOT PAY` 拒绝出结果。** 宁可没答案，不要错答案。

### 你需要给工具什么

每个部门给：
1. **KPI 基线 + stretch 目标**（如销售：基线 ¥200M，stretch ¥230M）
2. **β——每单位 KPI 值多少利润**（如每 ¥1 营收 → ¥0.08 利润）
3. **人头数**（如销售 20 人）
4. **β 的 95% 置信区间**（回归会自动给出）——用来折价不靠谱的估计
5. **责任份额 quota**（可选）——这个部门该扛公司利润缺口的百分之多少

加上公司层面的三个数字：奖金池总额、利润目标、利润基线。
...
外加一个可下载的 Excel，6 个 sheet 留作审计。

### 为什么比你们现在的 Excel 表强

- **苹果比苹果。** 销售和采购终于能放一起比了。
- **可审计。** 每个奖金数字都能追到公式。不是"老板说"。
- **诚实承认不确定。** 飘的估计不会变成真钱。
- **公平是数学保证的。** 同贡献 → 同奖金，是算出来的，不是许愿的。

想直接用，跳到 [§4 快速开始](#4-快速开始)。想搞懂每一步*为什么*，下面 [大白话版](#给赶时间的人大白话版) 有 12 行代码版，README 剩下的部分解释每一行。
